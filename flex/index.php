...
<html>
<head>
	<title>Project AEDES - CALABARZON</title>
	...
	<div class="w3-row">
		...
		<div class="w3-col w3-white l10">
			...
			<section class="w3-padding">
				...
				<ul><li><a class="w3-text-indigo" href="http://twitter.com/economox">Mox Ballo</a>, Data Science Scholar</li>
				<li><a class="w3-text-indigo" href="https://www.linkedin.com/in/rachemelendres/">Rachelle Melendres</a>, Data Science Scholar</li>
				<li><a class="w3-text-indigo" href="https://www.linkedin.com/in/janinepadilla/">Janine Padilla</a>, Data Science Scholar</li>
				
				<p>Wanna Hire Us? Contact us via Linked-IN <a class="w3-text-indigo"></a>.</p>
			</section>
